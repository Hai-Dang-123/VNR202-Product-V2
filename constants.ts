...
// Resolve asset URLs at build time using new URL(...) directly so Vite can
// rewrite them to the final hashed paths. Using a helper that calls new URL
// with a dynamic parameter prevents the bundler from statically analyzing
// the path which can lead to duplicated `/assets/assets/...` when the
// module is served from the built chunk location.
...
export const QUIZ_DATA: QuizItem[] = [
  ...
  imageUrl: new URL('./assets/chuong-1/1.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-1/2.jpeg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-1/3.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-1/4.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-1/5.png', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-1/6.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-1/7.png', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-1/8.png', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-1/9.png', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-1/10.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/1.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/2.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/3.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/4.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/5.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/6.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/7.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/8.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/9.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-2/10.jpg', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-3/1.png', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-3/2.png', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-3/3.png', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-3/4.png', import.meta.url).href,
    answer: 'Bao cấp',
    chapter: 'Chương 3: Đảng lãnh đạo cả nước quá độ lên chủ nghĩa xã hội và tiến hành công cuộc đổi mới (1975 - 2018) - I. Đảng lãnh đạo cả nước xây dựng chủ nghĩa xã hội và bảo vệ Tổ quốc (1975 - 1986)',
  ...
  imageUrl: new URL('./assets/chuong-3/5.png', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-3/6.png', import.meta.url).href,
  ...
  imageUrl: new URL('./assets/chuong-3/7.png', import.meta.url).href,
    answer: 'Đại hội Đảng',
